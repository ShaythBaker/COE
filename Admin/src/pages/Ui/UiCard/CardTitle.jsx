    ...
    return (
        <React.Fragment>
            <Row>
                <Col lg={4}>
                    <Card>
                        <img className="card-img img-fluid" src={img5} alt="Travco - COE" />
                        <CardBody>
                ...
                <Col lg={4}>
                    <Card>
                        ...
                        <img className="card-img img-fluid" src={img7} alt="Travco - COE" />
                    </Card>
                </Col>

                <Col lg={4}>
                    <Card>
                        <img className="card-img img-fluid" src={img6} alt="Travco - COE" />
