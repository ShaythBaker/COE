...
const projects = [
  {
    ...
    files: [
      { name: "Travco - COE Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Travco - COE Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Travco - COE Logo.Zip", size: "2.02 MB", link: "#" },
