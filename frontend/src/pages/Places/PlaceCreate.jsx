...
const AttachmentCarousel = ({ attachmentIds = [] }) => {
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto" }}>
      <Carousel activeIndex={activeIndex} next={next} previous={prev} ride={false}>
        <CarouselIndicators
          items={slides}
...
const PlacesListInner = () => {
  ...
  const areaLabel = useCallback(
    (areaId) => {
      ...
      const found = areas?.find((a) => Number(a.LIST_ITEM_ID) === Number(areaId));
  ...
  const updateDzFile = (id, patch) => {
    setDzFiles((prev) => prev.map((f) => (f.id === id ? { ...f, ...patch } : f)));
  };
                ...
                <Form>
                  <ModalBody>
                      ...
                      <Col md="6">
                        <FormGroup>
                          ...
                          <Input
                            ...
                            onBlur={handleBlur}
                            invalid={!!(touched.PLACE_NAME && errors.PLACE_NAME)}
                          />
                    ...
                    <FormGroup>
                      ...
                      <div className="mt-3">
                        <AttachmentCarousel attachmentIds={uploadedAttachmentIds} />
                      </div>

                      <small className="text-muted d-block mt-2">
                        Files are uploaded using the same S3 flow as the client logo (attachments module).
                      </small>
                    </FormGroup>
                  </ModalBody>
                  ...
                  <ModalFooter>
                    ...
                    <Button type="submit" color="success" disabled={createDisabled}>
                      {createDisabled ? (
                        <>
                          <Spinner size="sm" className="me-2" />
